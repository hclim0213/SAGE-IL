...
from sage.data.dataset import load_pretrain_dataset
from sage.runners import PreTrainer
from sage.utils.load_funcs import load_apprentice_handler, load_generator, load_logger
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_path", type=str, default="/workspace/_ext/data/datasets/zinc"
    )
    parser.add_argument(
    ...
    parser.add_argument("--save_root", default="/workspace/_ext/data/pretrained_models/models/")
    ...
    train_dataset = load_pretrain_dataset(char_dict=char_dict, smiles_path=args.dataset_path, code='train')
    valid_dataset = load_pretrain_dataset(char_dict=char_dict, smiles_path=args.dataset_path, code='valid')
    test_dataset = load_pretrain_dataset(char_dict=char_dict, smiles_path=args.dataset_path, code='test')
