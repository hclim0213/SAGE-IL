...
from sage.models.attribution import DirectedMessagePassingNetwork, GraphConvNetwork
...
def load_neural_apprentice(args):
    if args.model_type == "LSTM":
        ...
        neural_apprentice = TransformerDecoderGenerator.load(load_dir=args.apprentice_load_dir)
    else:
